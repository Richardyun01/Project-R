...
public class MeleeWeapon extends Weapon {
	...
	public ArrayList<String> actions(Hero hero) {
		...
		if (isEquipped(hero) && hero.heroClass == HeroClass.CARROLL){
	...
	public String info() {
		...
		if (Dungeon.hero.heroClass == HeroClass.CARROLL && !(this instanceof MagesStaff)){
	...
	public static class Charger extends Buff implements ActionIndicator.Action {
		...
		public boolean act() {
			...
			if (Dungeon.hero.subClass == HeroSubClass.CHALLENGER
			...
			if (ActionIndicator.action != this && Dungeon.hero.subClass == HeroSubClass.CHALLENGER) {
		...
		public void fx(boolean on) {
			if (on && Dungeon.hero.subClass == HeroSubClass.CHALLENGER) {
				ActionIndicator.setAction(this);
			}
		}
