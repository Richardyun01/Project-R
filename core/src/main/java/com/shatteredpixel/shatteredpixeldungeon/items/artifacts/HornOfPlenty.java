...
public class HornOfPlenty extends Artifact {
	...
	public ArrayList<String> actions( Hero hero ) {
		...
		if (hero.buff(MagicImmune.class) != null || (hero.belongings.weapon != null && (Dungeon.hero.belongings.weapon.weaponarm))) return actions;
		...
		if (action.equals(AC_EAT) || action.equals(AC_SNACK)){
			...
			if (!isEquipped(hero)) GLog.i( Messages.get(Artifact.class, "need_to_equip") );
				...
				if (Dungeon.hero.hasTalent(Talent.IRON_STOMACH)
						...
						|| Dungeon.hero.hasTalent(Talent.INFINITE_MEAL)
						|| Dungeon.hero.hasTalent(Talent.SECRET_MEAL)
						|| Dungeon.hero.hasTalent(Talent.IRON_MEAL)
						|| Dungeon.hero.hasTalent(Talent.FOCUSED_MEAL)
						|| Dungeon.hero.hasTalent(Talent.FROZEN_MEAL)){
