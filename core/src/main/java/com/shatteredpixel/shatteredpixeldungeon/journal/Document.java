...
public enum Document {
	...
	//ENEMY_GUIDE(ItemSpriteSheet.ENEMY_PAGE, false),
	...
	public Image pageSprite(String page){
		if (page.isEmpty() || !isPageFound(page) || this != ADVENTURERS_GUIDE){
			...
			switch (page){
				...
				case "Firearm":
					return new ItemSprite( ItemSpriteSheet.ELEGUN );
			}
		}
	}
	...
	static {
		...
		ADVENTURERS_GUIDE.pagesStates.put("Firearm",            debug ? READ : NOT_FOUND);
