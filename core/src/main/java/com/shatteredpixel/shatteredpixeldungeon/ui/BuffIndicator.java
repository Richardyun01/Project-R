...
public class BuffIndicator extends Component {
	...
	public static final int BLOOD_BULLET= 64;
	public static final int AFTER_IMAGE = 65;
	public static final int DUEL_CLEAVE = 66;
	public static final int DUEL_GUARD  = 67;
	public static final int DUEL_SPIN   = 68;
	public static final int DUEL_EVASIVE= 69;
	...
	public static final int DUEL_SHOTGUN= 77;
	public static final int DUEL_BOMB	= 78;
	public static final int DUEL_ENERGY = 79;
	public static final int DUEL_ETC 	= 80;
	public static final int CHALLENGE   = 81;
	public static final int CARROLL_COMBO= 82;
