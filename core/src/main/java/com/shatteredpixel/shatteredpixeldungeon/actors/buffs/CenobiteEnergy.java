...
import com.shatteredpixel.shatteredpixeldungeon.windows.WndCenobiteAbilities;
...
public class CenobiteEnergy extends Buff implements ActionIndicator.Action {
    ...
    @Override
    public int icon() {
        return BuffIndicator.CENOBITE_ENERGY;
    }
    ...
    public void abilityUsed( CenobiteAbility abil ){
    ...
    public int actionIcon() {
        return HeroIcon.CENOBITE_ABILITY;
    }
    ...
    public void doAction() {
        GameScene.show(new WndCenobiteAbilities(this));
    }

    public static abstract class CenobiteAbility {

        public static CenobiteAbility[] abilities = new CenobiteAbility[]{
                new Flurry(),
                new Focus(),
                new Dash(),
                new DragonKick(),
        ...
        public static class Flurry extends CenobiteAbility {
                        ...
                        if (enemy.isAlive()){
                            hero.sprite.attack(enemy.pos, new Callback() {
                                ...
                                public void call() {
                                    ...
                                    hero.next();
                                    tracker.detach();
                                    Buff.affect(hero, CenobiteEnergy.class).abilityUsed(Flurry.this);
        ...
        public static class Focus extends CenobiteAbility {
            ...
            public int cooldown() {
                ...
                return Buff.affect(Dungeon.hero, CenobiteEnergy.class).abilitiesEmpowered(Dungeon.hero) ? 5 : 6;
            }
        ...
        public static class DragonKick extends CenobiteAbility {
            ...
            public void doAbility(Hero hero, Integer target) {
                ...
                hero.sprite.attack(enemy.pos, new Callback() {
                    ...
                    public void call() {
                        ...
                        tracker.detach();
                        Buff.affect(hero, CenobiteEnergy.class).abilityUsed(DragonKick.this);
        ...
        public static class Meditate extends CenobiteAbility {
