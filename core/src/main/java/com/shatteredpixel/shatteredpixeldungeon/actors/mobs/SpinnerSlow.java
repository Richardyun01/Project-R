...
import com.shatteredpixel.shatteredpixeldungeon.sprites.SpinnerSlowSprite;
import com.watabou.utils.Bundle;
import com.watabou.utils.PathFinder;
import com.watabou.utils.Random;

public class SpinnerSlow extends Mob {

    {
        spriteClass = SpinnerSlowSprite.class;
    ...
    public int attackProc(Char enemy, int damage) {
        ...
        if (Random.Int(2) == 0) {
            ...
            Buff.affect(enemy, Slow.class, duration);
            webCoolDown = 0;
        }
