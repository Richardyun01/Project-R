...
public enum Talent {
	...
	//Inrush Barrier T4
	SHIELD_AMPLIFICATION(373, 4), TORCH_LIGHT(374, 4), RESOLVE(375, 4),
	//Immobile Trap T4
	SPIKE_TRAP(376, 4), AREA_DENIAL(377, 4), PURSUIT_DETERRANCE(378, 4),
	//Thruster T4
	ANTI_GRAVITY_PARA(379, 4), PARATROOPER(380, 4), LIGHTWEIGHT_BOOSTER(381, 4),
	...
	public static class CasCoolDown extends FlavourBuff{
		public int icon() { return BuffIndicator.TIME; }
		public void tintIcon(Image icon) { icon.hardlight(0.35f, 0f, 0.7f); }
		public float iconFadePercent() { return Math.max(0, visualcooldown() / (50*(1-0.1f*Dungeon.hero.pointsInTalent(Talent.ENHANCED_SHIP)))); }
	};
	public static class SupplyICoolDown extends FlavourBuff{
		public int icon() { return BuffIndicator.TIME; }
		public void tintIcon(Image icon) { icon.hardlight(0.35f, 0f, 0.7f); }
		public float iconFadePercent() { return Math.max(0, visualcooldown() / (500*(1-0.1f*Dungeon.hero.pointsInTalent(Talent.ENHANCED_SHIP)))); }
	};
	...
	public static class SupplyIICoolDown extends FlavourBuff{
		public int icon() { return BuffIndicator.TIME; }
		public void tintIcon(Image icon) { icon.hardlight(0.35f, 0f, 0.7f); }
		public float iconFadePercent() { return Math.max(0, visualcooldown() / (1500*(1-0.1f*Dungeon.hero.pointsInTalent(Talent.ENHANCED_SHIP)))); }
	};
